...
export default function ResetPasswordPage() {
  ...
  useEffect(() => {
    // Supabase는 이메일 링크 클릭 시 URL hash에 access_token을 포함해서 전달
    // onAuthStateChange에서 PASSWORD_RECOVERY 이벤트를 받으면 세션이 활성화됨
